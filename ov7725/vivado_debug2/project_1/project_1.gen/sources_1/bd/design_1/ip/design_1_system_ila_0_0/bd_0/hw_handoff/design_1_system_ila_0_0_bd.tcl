...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list \
   ...
   CONFIG.C_ILA_CLK_FREQ {24000000} \
  ...
  connect_bd_net -net SLOT_0_VID_IO_active_video_1 [get_bd_ports SLOT_0_VID_IO_active_video] [get_bd_pins ila_lib/probe7]
  connect_bd_net -net SLOT_0_VID_IO_data_1 [get_bd_ports SLOT_0_VID_IO_data] [get_bd_pins ila_lib/probe6]
  connect_bd_net -net SLOT_0_VID_IO_vsync_1 [get_bd_ports SLOT_0_VID_IO_vsync] [get_bd_pins ila_lib/probe8]
