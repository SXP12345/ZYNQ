...
proc create_root_design { parentCell } {
  ...
  set GPIO_EMIO_0 [ create_bd_intf_port -mode Master -vlnv xilinx.com:interface:gpio_rtl:1.0 GPIO_EMIO_0 ]
...
1#UART 1#GPIO#GPIO#GPIO#GPIO}\
  ...
  connect_bd_intf_net -intf_net processing_system7_0_GPIO_0 [get_bd_intf_ports GPIO_EMIO_0] [get_bd_intf_pins processing_system7_0/GPIO_0]
