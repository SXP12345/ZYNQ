...
vlog -work axi_infrastructure_v1_1_0  -v2k5 "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl" "+incdir+D:/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
"../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl/axi_infrastructure_v1_1_vl_rfs.v" \

vlog -work axi_vip_v1_1_10  -sv2k12 "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl" "+incdir+D:/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
"../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/0980/hdl/axi_vip_v1_1_vl_rfs.sv" \

vlog -work processing_system7_vip_v1_0_12  -sv2k12 "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl" "+incdir+D:/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
"../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \

vlog -work xil_defaultlib  -v2k5 "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl" "+incdir+../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl" "+incdir+D:/Xilinx/Vivado/2021.1/data/xilinx_vip/include" \
