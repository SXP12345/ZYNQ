...
HD_PWD='C:/Users/SUXP/Desktop/ov7725/analog_ov/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log analog_ov.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source analog_ov.tcl
