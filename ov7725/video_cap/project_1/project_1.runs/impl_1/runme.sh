...
HD_PWD='C:/Users/SUXP/Desktop/ov7725/video_cap/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ov7725_data_sample.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ov7725_data_sample.tcl -notrace
