...
execute()
{
  irun $irun_opts \
       ...
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl" \
       +incdir+"../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/ec67/hdl" \
       +incdir+"../../../../GPIO_MIO_LED.gen/sources_1/bd/system/ipshared/f42d/hdl" \
