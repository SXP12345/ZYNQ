...
HD_PWD='C:/Users/SUXP/Desktop/ov7725/analog_ov/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log analog_ov.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source analog_ov.tcl -notrace
